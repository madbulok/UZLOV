...
public class HotsPostFragment : Fragment(), LoadableObjects<Post>, ReConnectable{
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(sectionNumber: Int): HotsPostFragment {
            return HotsPostFragment().apply {
    ...
    override fun reconnect() {
        ...
        if (repository != null) repository?.getHotsPost()
        println("reconnect hot fragment")
    }
}