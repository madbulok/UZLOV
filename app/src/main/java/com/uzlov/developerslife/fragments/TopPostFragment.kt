...
class TopPostFragment : Fragment() , LoadableObjects<Post>, ReConnectable {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(sectionNumber: Int): TopPostFragment {
            return TopPostFragment().apply {
...
//        Toast.makeText(context, getString(R.string.error_response_api), Toast.LENGTH_SHORT).show()
    ...
    override fun reconnect() {
        ...
        if (repository != null) repository?.getTopPosts()
        println("reconnect top fragment")
    }
}
